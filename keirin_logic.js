...
function getScenarioCoeffs(scenario) {
    if (scenario === '先行有利') return { '逃': 1.06, '自': 1.05, '両': 1.03, '追': 1.02, '差': 1.00 };
    if (scenario === '捲り有利') return { '逃': 1.00, '自': 1.00, '両': 1.04, '追': 1.05, '差': 1.05 };
    if (scenario === '差し有利') return { '逃': 0.88, '自': 0.90, '両': 1.05, '追': 1.08, '差': 1.08 };
    return { '逃': 1.0, '自': 1.0, '両': 1.0, '追': 1.0, '差': 1.0 };
}
